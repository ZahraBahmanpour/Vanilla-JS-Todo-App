...
export const tasks = [
  ...
  },
  {
    id: "4",
    title: "Running",
    date: new Date("2023-08-6"),
    startTime: new Date("2023-08-6").setHours(8, 30),
    endTime: new Date("2023-08-6").setHours(10, 30),
    categoryId: 4,
  ...
  },
  {
    ...
    title: "Lunch",
    date: new Date('"2023-08-6"'),
    startTime: new Date("2023-08-6").setHours(11, 30),
    endTime: new Date("2023-08-6").setHours(12, 0),
    categoryId: 5,
